...
## Результат
1. В директории MyLibrary находится проект библиотеки
2. В директории TestFigures находятся проект с Unit тестами для библиотеки
3. В файле Task2.sql находится решение второго задания
